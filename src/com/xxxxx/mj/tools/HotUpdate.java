...
//    }
    ...
    public void runGame(String updateUrl, boolean runFlag) {
        ((EntryActivity)context).runGameAfterHotUpdate(updateUrl, runFlag);
    }
    ...
    public class HotUpdateTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... params) {
            ...
            try {
            	...
            	Debugs.debug("Exception at get code_url errMsg:" + e.toString());
                return "json_error";
            }
            ...
            if(needUpdateCode){
                ...
                try {
                	...
                	Debugs.debug("Exception download_or_unzip errMsg" + e.toString());
        ...
        protected void onPostExecute(String result) {
            //获得更新配置json失败，在此处处理
        	Debugs.debug("onPostExecute result:" + result);
            if (result.equals("json_error")){
            	runGame(updateUrl, false);
            }
            //下载或者解压缩失败，在此处处理
...
//            progressBar.setProgress(values[0]);
        ...
        public String getGameJson() {
            ...
            try {
                ...
                if(response.getStatusLine().getStatusCode()== HttpStatus.SC_OK){
                    Debugs.debug("getGameJson 请求服务器端成功");
                	...
                	Debugs.debug("getGameJson 请求服务器端失败");
                }
            } catch (Exception e) {
                // TODO Auto-generated catch block
                Debugs.debug("getGameJson Exception errMsg:" + e.toString());
            }
            Debugs.debug("getGameJson jsonInfo:" + "[" + jsonInfo + "]");
            return jsonInfo;
        }
        ...
        public String getGameZip(String loaderUrl) {
            ...
            try {
            	...
            	Debugs.debug("getGameZip Exception errMsg:" + e.toString());
            } finally {
                if (conn != null) {
                    conn.disconnect();
                }
        ...
        public void unzip(String filePath, String gamePath) {
            ...
            try {
            	...
            	Debugs.debug("unzip Exception errMsg:" + e.toString());
            }
        }
        ...
        private int unzipEntry(ZipFile zipFile, ZipEntry zipEntry, String gamePath) {
            ...
            try {
            	...
            	Debugs.debug("unzipEntry Exception errMsg:" + e.toString());
            }
